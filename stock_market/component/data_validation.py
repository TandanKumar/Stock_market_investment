...
from stock_market.entity.config_entity import DataValidationConfig
from stock_market.entity.artifact_entity import DataIngestionArtifact,DataValidationArtifact
import os,sys
import pandas  as pd
